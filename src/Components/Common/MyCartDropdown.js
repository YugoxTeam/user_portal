...
const MyCartDropdown = () => {
    ...
    const cartData = [
        { id: 1, product: "Branded T-Shirts", quantity: 10, price: 32 },
        { id: 2, product: "Bentwood Chair", quantity: 5, price: 18 },
        { id: 3, product: "Borosil Paper Cup", quantity: 3, price: 250 },
        { id: 4, product: "Gray Styled T-Shirt", quantity: 1, price: 1250 },
        { id: 5, product: "Stillbird Helmet", quantity: 2, price: 495 },
    ];
